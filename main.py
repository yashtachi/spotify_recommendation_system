...
if 'p_url' not in st.session_state:
    st.session_state.p_url = 'Example: https://open.spotify.com/playlist/29DmOtYHeymG5XZMUy4nVg?si=a9630eb415e64f4e'
...
if 'a_url' not in st.session_state:
    st.session_state.a_url = 'Example: https://open.spotify.com/artist/4YRxDV8wJFPHPTeXepOstw?si=a79n4DPJRhWd6vXCAa5x2Q'
...
def play_recomm():
    ...
    try:
        if len(pd.read_csv('new_tracks.csv')) >= 200:
